...
namespace uPLibrary.Networking.M2Mqtt
{
    ...
    public class M2MqttClient
    {
        ...
        /// MQTT Client Session
        /// </summary>
        public M2MqttClientSession Session
        {
        ...
        [Obsolete("Use this ctor M2MqttClient(string brokerHostName) insted")]
        public M2MqttClient(IPAddress brokerIpAddress) :
        ...
        [Obsolete("Use this ctor M2MqttClient(string brokerHostName, int brokerPort, bool secure, X509Certificate caCert) insted")]
        public M2MqttClient(IPAddress brokerIpAddress, int brokerPort, bool secure, X509Certificate caCert, X509Certificate clientCert, MqttSslProtocols sslProtocol)
        {
        ...
        public M2MqttClient(string brokerHostName) :
#if !(WINDOWS_APP || WINDOWS_PHONE_APP || (!UNITY_EDITOR&&UNITY_WSA_10_0&&!ENABLE_IL2CPP))
...
#else
        public M2MqttClient(string brokerHostName, int brokerPort, bool secure, MqttSslProtocols sslProtocol)            
#endif
        {
        ...
        public M2MqttClient(IMqttNetworkChannel channel)
        {
        ...
        public void LoadSession(M2MqttClientSession session)
        {
            // if not clean session
            if (!this.CleanSession)
            {
